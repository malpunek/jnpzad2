...
//	-Zmienne globalne w anonimowym namespace{}, albo jakiś inny sposób ukrycia przed światem -Stasiek (zrobione?)
//	-asercje (?)									- Kacper (moim zdaniem nie trzeba)
//	-Extern "C"										- Stasiek (zrobione?)
//	-Zamknąć wszystko w namespace jnp1{}			- Stasiek (zrobione?)
//	-Zmienić nazwy plików na .cc					- Stasiek (zrobione?)
